...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibHNpbHZhOTIiLCJhIjoiY2tlbmIxYmp2MTRvNzJxbndxZ2dnNWduciJ9.lV4Q2oIIZOMOVpOV3p5FeA';
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'See ya later'); //location.reload(true);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'User created succesfully!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
          ...
          case 7:
            ...
            if (_context.t0.response.data.error.code === 11000) {
              (0, _alerts.showAlert)('error', 'This User account already exists');
            } else {
              (0, _alerts.showAlert)('error', _context.t0.response.data.message);
            }
...
exports.editReview = exports.createReview = void 0;
...
var createReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tour, review, rating) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
var editReview = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(id, review, rating) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
  ...
  return function editReview(_x4, _x5, _x6) {
    return _ref2.apply(this, arguments);
  };
}();
...
exports.deleteLikeTour = exports.addLikeTour = void 0;
...
var addLikeTour = /*#__PURE__*/function () {
  ...
  return function addLikeTour(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.addLikeTour = addLikeTour;

var deleteLikeTour = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(tour) {
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
  ...
  return function deleteLikeTour(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

exports.deleteLikeTour = deleteLikeTour;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"manageBO.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.exportDoc = exports.manageUsers = exports.manageTours = void 0;
...
var manageTours = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(id, name, duration, price, maxGroupSize) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "api/v1/backoffice/".concat(id),
              data: {
                name: name,
                duration: duration,
                price: price,
  ...
  return function manageTours(_x, _x2, _x3, _x4, _x5) {
    return _ref.apply(this, arguments);
  };
}();

exports.manageTours = manageTours;

var manageUsers = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(id, user, email, role, active, retry) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
  ...
  return function manageUsers(_x6, _x7, _x8, _x9, _x10, _x11) {
    return _ref2.apply(this, arguments);
  };
}();
...
var exportDoc = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(col) {
    var res, _res;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Export concluded succesfully!!');
              window.setTimeout(function () {
                location.assign('/manageTours');
              }, 1500);
            }
  ...
  return function exportDoc(_x12) {
...
var _manageBO = require("./manageBO");
...
var editTable = document.querySelectorAll('.edit--table');
...
var userTable = document.querySelector('.user'); //VALUES
//DELEGATION
...
if (reviewStar) reviewStar.addEventListener('click', function (e) {
  ...
  for (var i = 0; i < star.length; i++) {
    if (rating >= star[i]) {
      document.getElementById("".concat(star[i])).classList.remove('reviews__star--inactive');
      document.getElementById("".concat(star[i])).classList.add('reviews__star--active');
    } else {
      document.getElementById("".concat(star[i])).classList.remove('reviews__star--active');
      document.getElementById("".concat(star[i])).classList.add('reviews__star--inactive');
    }
  }
});
...
if (likeTour) likeTour.addEventListener('click', function (e) {
  ...
  if (like) {
    (0, _like.addLikeTour)(tourId);
  } else {
    (0, _like.deleteLikeTour)(tourId);
  }
}); //BackOffice  

if (table) {
  var _loop = function _loop(i) {
    editTable[i].addEventListener('click', function (e) {
      var editContent = editTable[i].closest('tr').querySelectorAll('.tcontent');
      ...
      var select = editTable[i].closest('tr').querySelectorAll('select');
  ...
  var _loop2 = function _loop2(_i) {
    cancelBtn[_i].addEventListener('click', function (e) {
      var editContent = editTable[_i].closest('tr').querySelectorAll('.tcontent');
      ...
      var select = editTable[_i].closest('tr').querySelectorAll('select');
      ...
      tableBtn[_i].classList.toggle('show');

      editTable[_i].classList.toggle('hide');
    });
  };

  for (var _i = 0; _i < editTable.length; _i++) {
    _loop2(_i);
  } //save button 


  var _loop3 = function _loop3(_i2) {
    saveBtn[_i2].addEventListener('click', function (e) {
      if (tourTable) {
        var id = editTable[_i2].closest('tr').dataset.id;

        var rows = editTable[_i2].closest('tr').querySelectorAll('.tcontent');
        ...
        var _id = editTable[_i2].closest('tr').dataset.id;

        var _rows = editTable[_i2].closest('tr').querySelectorAll('.tcontent');

        var selectActive = _rows[3].getElementsByTagName('select');

        var selectRole = _rows[2].getElementsByTagName('select');

        var user = _rows[0].innerHTML;
        var email = _rows[1].innerHTML;
        var role = selectRole[0].options[selectRole[0].selectedIndex].text;
        var active = selectActive[0].options[selectActive[0].selectedIndex].text;
        var retry = _rows[4].innerHTML;
        (0, _manageBO.manageUsers)(_id, user, email, role, active, retry);
      }
    });
  };

  for (var _i2 = 0; _i2 < editTable.length; _i2++) {
    _loop3(_i2);
  }
