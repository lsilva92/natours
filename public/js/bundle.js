...
var editTable = document.querySelector('.edit--table'); //VALUES
//DELEGATION
...
if (editTable) editTable.addEventListener('click', function (e) {
  var x = document.querySelectorAll('.tcontent');
